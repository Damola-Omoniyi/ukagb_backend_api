...
urlpatterns = [
    ...
    path("<str:exam_board_name>/<str:subject_name>/statistics/", views.GradeStatisticList.as_view(), name = "grade-statistic-list"),
    path("<str:exam_board_name>/<str:subject_name>/<int:year>/", views.ComponentGradeList.as_view(), name="component-grade-list"),
    path("<str:exam_board_name>/<str:subject_name>/<int:year>/<int:paper_number>/", views.DocumentURLList.as_view(), name="url-list")
]
